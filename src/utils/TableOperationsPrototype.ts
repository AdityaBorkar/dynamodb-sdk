...
>(props: {
  ...
  return {
     ...
     * @docs {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/dynamodb/command/BatchGetItemCommand/ | dynamodb-sdk Documentation}
     * @api {@link https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/dynamodb/command/BatchGetItemCommand/ | dynamodb-sdk API Reference}
